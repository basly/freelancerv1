 ...
 * @ORM\Entity(repositoryClass="MyApp\JobOwnerBundle\Repository\ChoixRepository")
 */
class Choix
{
    /**
    ...
    /**
     *
     * @ORM\ManyToOne(targetEntity="MyApp\JobOwnerBundle\Entity\Question",inversedBy="id")
